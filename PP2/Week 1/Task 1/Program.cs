    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var o in arr)//прохожу по каждому элементу массива
            {
                ...
                for (int i = 2; i <= Math.Sqrt(t); i++)//создаю цикл и прохожу с 1 до t
                {
                    bool k = true;//создаю переменную типа int и присваиваю значение 0
                    if (t%i==0 && t!=1)//ставлю условие: если t по модулю
                    {
                        k=false;  //увеличиваю на 1
                    }
                }
                if(k)//ставлю условие:если к равняется 2
                {
